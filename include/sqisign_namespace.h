...
#elif defined(SQISIGN_BUILD_TYPE_FIAT_CRYPTO)
#define SQISIGN_NAMESPACE(s) PARAM_NAME3(fiat_crypto, s)
...
#define quat_alg_elem_mul_by_scalar                                            \
  SQISIGN_NAMESPACE_GENERIC(quat_alg_elem_mul_by_scalar)
...
#define quat_alg_make_primitive                                                \
  SQISIGN_NAMESPACE_GENERIC(quat_alg_make_primitive)
...
#define ec_curve_to_basis_2f_from_hint                                         \
  SQISIGN_NAMESPACE(ec_curve_to_basis_2f_from_hint)
#define ec_curve_to_basis_2f_to_hint                                           \
  SQISIGN_NAMESPACE(ec_curve_to_basis_2f_to_hint)
...
#undef ec_dlog_2_tate_R
#undef ec_dlog_2_weil
#undef ec_dlog_3_weil
#undef ec_dlog_3_weil_R
#undef ec_dlog_3_tate
#undef ec_dlog_3_tate_R
#undef fp2_frob
#undef reduced_tate
#undef weil
...
#define ec_dlog_2_tate_R SQISIGN_NAMESPACE(ec_dlog_2_tate_R)
#define ec_dlog_2_weil SQISIGN_NAMESPACE(ec_dlog_2_weil)
#define ec_dlog_3_weil SQISIGN_NAMESPACE(ec_dlog_3_weil)
#define ec_dlog_3_weil_R SQISIGN_NAMESPACE(ec_dlog_3_weil_R)
#define ec_dlog_3_tate SQISIGN_NAMESPACE(ec_dlog_3_tate)
#define ec_dlog_3_tate_R SQISIGN_NAMESPACE(ec_dlog_3_tate_R)
...
#define ibz_mat_2x2_det_from_ibz                                               \
  SQISIGN_NAMESPACE_GENERIC(ibz_mat_2x2_det_from_ibz)
...
#define dim2id2iso_arbitrary_isogeny_evaluation                                \
  SQISIGN_NAMESPACE(dim2id2iso_arbitrary_isogeny_evaluation)
#define dim2id2iso_ideal_to_isogeny_clapotis                                   \
  SQISIGN_NAMESPACE(dim2id2iso_ideal_to_isogeny_clapotis)
#define find_uv SQISIGN_NAMESPACE(find_uv)
#define fixed_degree_isogeny_and_eval                                          \
  SQISIGN_NAMESPACE(fixed_degree_isogeny_and_eval)
...
#define ibz_inv_dim4_make_coeff_mpm                                            \
  SQISIGN_NAMESPACE_GENERIC(ibz_inv_dim4_make_coeff_mpm)
#define ibz_inv_dim4_make_coeff_pmp                                            \
  SQISIGN_NAMESPACE_GENERIC(ibz_inv_dim4_make_coeff_pmp)
...
#define ibz_mat_4x4_inv_with_det_as_denom                                      \
  SQISIGN_NAMESPACE_GENERIC(ibz_mat_4x4_inv_with_det_as_denom)
#define ibz_mat_4x4_is_identity                                                \
  SQISIGN_NAMESPACE_GENERIC(ibz_mat_4x4_is_identity)
...
#define ibz_vec_4_linear_combination                                           \
  SQISIGN_NAMESPACE_GENERIC(ibz_vec_4_linear_combination)
...
#define ec_dlog_2 SQISIGN_NAMESPACE(ec_dlog_2)
#define ec_dlog_3 SQISIGN_NAMESPACE(ec_dlog_3)
#define ec_eval_odd SQISIGN_NAMESPACE(ec_eval_odd)
#define ec_eval_three SQISIGN_NAMESPACE(ec_eval_three)
#define ec_eval_three_prev SQISIGN_NAMESPACE(ec_eval_three_prev)
...
#define test_point_order_twof SQISIGN_NAMESPACE(test_point_order_twof)
...
#define quat_left_ideal_finalize                                               \
  SQISIGN_NAMESPACE_GENERIC(quat_left_ideal_finalize)
...
// Namespacing symbols exported from fp.c, fp_p27500_64.c, fp_p5248_64.c,
// fp_p65376_64.c:
#undef fp_exp3div4
#undef fp_inv
#undef fp_is_square
...
// Namespacing symbols exported from fp_p27500_64.c, fp_p5248_64.c,
// fp_p65376_64.c:
#undef fp_copy
#undef fp_cswap
#undef fp_decode
...
// Namespacing symbols exported from fp_p27500_64.c, fp_p5248_64.c,
// fp_p65376_64.c, gf27500.c, gf5248.c, gf65376.c:
#undef fp_add
#undef fp_mul
#undef fp_sqr
#undef fp_sub
...
#define double_couple_jac_point_iter                                           \
  SQISIGN_NAMESPACE(double_couple_jac_point_iter)
...
#define ibz_mat_4xn_hnf_mod_core                                               \
  SQISIGN_NAMESPACE_GENERIC(ibz_mat_4xn_hnf_mod_core)
#define ibz_vec_4_copy_mod SQISIGN_NAMESPACE_GENERIC(ibz_vec_4_copy_mod)
#define ibz_vec_4_linear_combination_mod                                       \
  SQISIGN_NAMESPACE_GENERIC(ibz_vec_4_linear_combination_mod)
#define ibz_vec_4_scalar_mul_mod                                               \
  SQISIGN_NAMESPACE_GENERIC(ibz_vec_4_scalar_mul_mod)
...
#undef id2iso_ideal_to_kernel_dlogs_odd
...
#define change_of_basis_matrix_tate_invert                                     \
  SQISIGN_NAMESPACE(change_of_basis_matrix_tate_invert)
#define ec_biscalar_mul_ibz_vec SQISIGN_NAMESPACE(ec_biscalar_mul_ibz_vec)
#define endomorphism_application_even_basis                                    \
  SQISIGN_NAMESPACE(endomorphism_application_even_basis)
#define id2iso_ideal_to_kernel_dlogs_even                                      \
  SQISIGN_NAMESPACE(id2iso_ideal_to_kernel_dlogs_even)
#define id2iso_ideal_to_kernel_dlogs_odd                                       \
  SQISIGN_NAMESPACE(id2iso_ideal_to_kernel_dlogs_odd)
#define id2iso_kernel_dlogs_to_ideal_even                                      \
  SQISIGN_NAMESPACE(id2iso_kernel_dlogs_to_ideal_even)
#define matrix_application_even_basis                                          \
  SQISIGN_NAMESPACE(matrix_application_even_basis)
...
#define quat_lideal_conjugate_without_hnf                                      \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_conjugate_without_hnf)
...
#define quat_lideal_create_principal                                           \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_create_principal)
...
#define quat_lideal_inverse_lattice_without_hnf                                \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_inverse_lattice_without_hnf)
...
#define quat_lideal_right_order                                                \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_right_order)
#define quat_lideal_right_transporter                                          \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_right_transporter)
#define quat_order_discriminant                                                \
  SQISIGN_NAMESPACE_GENERIC(quat_order_discriminant)
...
#define ibz_rand_interval_minm_m                                               \
  SQISIGN_NAMESPACE_GENERIC(ibz_rand_interval_minm_m)
...
#define quat_lattice_bound_parallelogram                                       \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_bound_parallelogram)
#define quat_lattice_sample_from_ball                                          \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_sample_from_ball)
...
#define quat_lattice_alg_elem_mul                                              \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_alg_elem_mul)
#define quat_lattice_conjugate_without_hnf                                     \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_conjugate_without_hnf)
#define quat_lattice_contains SQISIGN_NAMESPACE_GENERIC(quat_lattice_contains)
#define quat_lattice_dual_without_hnf                                          \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_dual_without_hnf)
...
#define quat_lattice_mat_alg_coord_mul_without_hnf                             \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_mat_alg_coord_mul_without_hnf)
#define quat_lattice_mul SQISIGN_NAMESPACE_GENERIC(quat_lattice_mul)
#define quat_lattice_reduce_denom                                              \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_reduce_denom)
...
#define quat_lideal_lideal_mul_reduced                                         \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_lideal_mul_reduced)
#define quat_lideal_prime_norm_reduced_equivalent                              \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_prime_norm_reduced_equivalent)
#define quat_lideal_reduce_basis                                               \
  SQISIGN_NAMESPACE_GENERIC(quat_lideal_reduce_basis)
...
#define quat_lll_gram_schmidt_transposed_with_ibq                              \
  SQISIGN_NAMESPACE_GENERIC(quat_lll_gram_schmidt_transposed_with_ibq)
#define quat_lll_set_ibq_parameters                                            \
  SQISIGN_NAMESPACE_GENERIC(quat_lll_set_ibq_parameters)
...
#define quat_change_to_O0_basis                                                \
  SQISIGN_NAMESPACE_GENERIC(quat_change_to_O0_basis)
#define quat_lattice_O0_set SQISIGN_NAMESPACE_GENERIC(quat_lattice_O0_set)
#define quat_lattice_O0_set_extremal                                           \
  SQISIGN_NAMESPACE_GENERIC(quat_lattice_O0_set_extremal)
...
#define quat_sampling_random_ideal_O0_given_norm                               \
  SQISIGN_NAMESPACE_GENERIC(quat_sampling_random_ideal_O0_given_norm)
...
#define quat_test_input_random_ideal_generation                                \
  SQISIGN_NAMESPACE_GENERIC(quat_test_input_random_ideal_generation)
#define quat_test_input_random_ideal_lattice_generation                        \
  SQISIGN_NAMESPACE_GENERIC(quat_test_input_random_ideal_lattice_generation)
#define quat_test_input_random_lattice_generation                              \
  SQISIGN_NAMESPACE_GENERIC(quat_test_input_random_lattice_generation)
...
#define theta_chain_compute_and_eval                                           \
  SQISIGN_NAMESPACE(theta_chain_compute_and_eval)
#define theta_chain_compute_and_eval_randomized                                \
  SQISIGN_NAMESPACE(theta_chain_compute_and_eval_randomized)
#define theta_chain_compute_and_eval_verify                                    \
  SQISIGN_NAMESPACE(theta_chain_compute_and_eval_verify)
...
#undef BASIS_EVEN
#undef BASIS_THREE
#undef BASIS_ODD_PLUS
#undef BASIS_ODD_MINUS
#undef BASIS_COMMITMENT_PLUS
#undef BASIS_COMMITMENT_MINUS
#undef BASIS_CHALLENGE
#undef CURVE_E0
#undef CURVE_E0_A24
#undef ACTION_I
#undef ACTION_J
...
#undef ACTION_GEN3
#undef ACTION_GEN4
#undef COMMITMENT_IDEAL_UNDISTORTED_GEN
#undef COMMITMENT_IDEAL_DISTORTION_ENDO

#define BASIS_EVEN SQISIGN_NAMESPACE(BASIS_EVEN)
#define BASIS_THREE SQISIGN_NAMESPACE(BASIS_THREE)
#define BASIS_ODD_PLUS SQISIGN_NAMESPACE(BASIS_ODD_PLUS)
#define BASIS_ODD_MINUS SQISIGN_NAMESPACE(BASIS_ODD_MINUS)
#define BASIS_COMMITMENT_PLUS SQISIGN_NAMESPACE(BASIS_COMMITMENT_PLUS)
#define BASIS_COMMITMENT_MINUS SQISIGN_NAMESPACE(BASIS_COMMITMENT_MINUS)
#define BASIS_CHALLENGE SQISIGN_NAMESPACE(BASIS_CHALLENGE)
#define CURVE_E0 SQISIGN_NAMESPACE(CURVE_E0)
#define CURVE_E0_A24 SQISIGN_NAMESPACE(CURVE_E0_A24)
#define ACTION_I SQISIGN_NAMESPACE(ACTION_I)
#define ACTION_J SQISIGN_NAMESPACE(ACTION_J)
#define ACTION_K SQISIGN_NAMESPACE(ACTION_K)
#define ACTION_GEN2 SQISIGN_NAMESPACE(ACTION_GEN2)
#define ACTION_GEN3 SQISIGN_NAMESPACE(ACTION_GEN3)
#define ACTION_GEN4 SQISIGN_NAMESPACE(ACTION_GEN4)
#define COMMITMENT_IDEAL_UNDISTORTED_GEN                                       \
  SQISIGN_NAMESPACE(COMMITMENT_IDEAL_UNDISTORTED_GEN)
#define COMMITMENT_IDEAL_DISTORTION_ENDO                                       \
  SQISIGN_NAMESPACE(COMMITMENT_IDEAL_DISTORTION_ENDO)
...
#undef TORSION_PLUS_EVEN_POWER
#undef TORSION_ODD_PRIMES
#undef TORSION_ODD_POWERS
#undef TORSION_PLUS_ODD_PRIMES
#undef TORSION_PLUS_ODD_POWERS
#undef TORSION_MINUS_ODD_PRIMES
#undef TORSION_MINUS_ODD_POWERS
#undef DEGREE_COMMITMENT_POWERS
#undef CHARACTERISTIC
#undef TORSION_ODD
#undef TORSION_ODD_PRIMEPOWERS
#undef TORSION_ODD_PLUS
#undef TORSION_ODD_MINUS
#undef TORSION_PLUS_2POWER
#undef TORSION_PLUS_3POWER
#undef TORSION_PLUS_23POWER
#undef DEGREE_COMMITMENT
#undef DEGREE_COMMITMENT_PLUS
#undef DEGREE_COMMITMENT_MINUS
#undef DEGREE_CHALLENGE

#define TORSION_PLUS_EVEN_POWER SQISIGN_NAMESPACE(TORSION_PLUS_EVEN_POWER)
#define TORSION_ODD_PRIMES SQISIGN_NAMESPACE(TORSION_ODD_PRIMES)
#define TORSION_ODD_POWERS SQISIGN_NAMESPACE(TORSION_ODD_POWERS)
#define TORSION_PLUS_ODD_PRIMES SQISIGN_NAMESPACE(TORSION_PLUS_ODD_PRIMES)
#define TORSION_PLUS_ODD_POWERS SQISIGN_NAMESPACE(TORSION_PLUS_ODD_POWERS)
#define TORSION_MINUS_ODD_PRIMES SQISIGN_NAMESPACE(TORSION_MINUS_ODD_PRIMES)
#define TORSION_MINUS_ODD_POWERS SQISIGN_NAMESPACE(TORSION_MINUS_ODD_POWERS)
#define DEGREE_COMMITMENT_POWERS SQISIGN_NAMESPACE(DEGREE_COMMITMENT_POWERS)
#define CHARACTERISTIC SQISIGN_NAMESPACE(CHARACTERISTIC)
#define TORSION_ODD SQISIGN_NAMESPACE(TORSION_ODD)
#define TORSION_ODD_PRIMEPOWERS SQISIGN_NAMESPACE(TORSION_ODD_PRIMEPOWERS)
#define TORSION_ODD_PLUS SQISIGN_NAMESPACE(TORSION_ODD_PLUS)
#define TORSION_ODD_MINUS SQISIGN_NAMESPACE(TORSION_ODD_MINUS)
#define TORSION_PLUS_2POWER SQISIGN_NAMESPACE(TORSION_PLUS_2POWER)
#define TORSION_PLUS_3POWER SQISIGN_NAMESPACE(TORSION_PLUS_3POWER)
#define TORSION_PLUS_23POWER SQISIGN_NAMESPACE(TORSION_PLUS_23POWER)
#define DEGREE_COMMITMENT SQISIGN_NAMESPACE(DEGREE_COMMITMENT)
#define DEGREE_COMMITMENT_PLUS SQISIGN_NAMESPACE(DEGREE_COMMITMENT_PLUS)
#define DEGREE_COMMITMENT_MINUS SQISIGN_NAMESPACE(DEGREE_COMMITMENT_MINUS)
#define DEGREE_CHALLENGE SQISIGN_NAMESPACE(DEGREE_CHALLENGE)

// Namespacing symbols exported from gf_constants.c:
#undef NQR_TABLE
#undef Z_NQR_TABLE
