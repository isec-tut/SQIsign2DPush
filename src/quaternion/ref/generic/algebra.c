...
void quat_alg_coord_add(quat_alg_coord_t *res, const quat_alg_coord_t *a,
                        const quat_alg_coord_t *b) {
...
void quat_alg_coord_sub(quat_alg_coord_t *res, const quat_alg_coord_t *a,
                        const quat_alg_coord_t *b) {
...
void quat_alg_equal_denom(quat_alg_elem_t *res_a, quat_alg_elem_t *res_b,
                          const quat_alg_elem_t *a, const quat_alg_elem_t *b) {
  ibz_t gcd, r;
  ibz_init(&gcd);
  ibz_init(&r);
...
void quat_alg_add(quat_alg_elem_t *res, const quat_alg_elem_t *a,
...
void quat_alg_sub(quat_alg_elem_t *res, const quat_alg_elem_t *a,
                  const quat_alg_elem_t *b) {
  quat_alg_elem_t res_a, res_b;
  quat_alg_elem_init(&res_a);
  quat_alg_elem_init(&res_b);
...
void quat_alg_mul(quat_alg_elem_t *res, const quat_alg_elem_t *a,
                  const quat_alg_elem_t *b, const quat_alg_t *alg) {
  ibz_t prod;
...
void quat_alg_rightmul_mat(ibz_mat_4x4_t *mulmat, const quat_alg_elem_t *a,
...
void quat_alg_norm(ibq_t *res, const quat_alg_elem_t *a,
                   const quat_alg_t *alg) {
...
void quat_alg_scalar(quat_alg_elem_t *elem, const ibz_t *numerator,
...
// defined in header
// int quat_alg_is_primitive(const quat_alg_elem_t *x, const quat_order_t
// *order, const quat_alg_t *alg) {
...
//}
//
// static inline void quat_alg_make_primitive(quat_alg_coord_t *primitive_x,
// ibz_t *content, const quat_alg_elem_t *x, const quat_order_t *order, const
// quat_alg_t *alg){
...
void quat_alg_elem_copy_ibz(quat_alg_elem_t *elem, const ibz_t *denom,
                            const ibz_t *coord0, const ibz_t *coord1,
...
void quat_alg_elem_set(quat_alg_elem_t *elem, int64_t denom, int64_t coord0,
                       int64_t coord1, int64_t coord2, int64_t coord3) {
...
void quat_alg_elem_mul_by_scalar(quat_alg_elem_t *res, const ibz_t *scalar,
