...
#elif RADIX == 64
#if defined(SQISIGN_GF_IMPL_BROADWELL)
        {0x3, 0x0, 0x0, 0x0, 0x1b2b314df93a3680, 0xd5761abab0083c2e,
         0x9620eb301db5ff9d, 0x1b03b46c6dcdcce2}
#else
        {0x3, 0x0, 0x0, 0x0, 0x1b2b314df93a3680, 0xd5761abab0083c2e,
         0x9620eb301db5ff9d, 0x1b03b46c6dcdcce2}
...
// 0x18a5883acc076d7, 0x360768d8db9b99}
    ...
    },
    {
        ...
        {0xfffffffffffffffc, 0xffffffffffffffff, 0xffffffffffffffff,
         0xffffffffffffffff, 0x311bbe42b3b261ff, 0xe3628707154a5a6d,
         0x8d2971152db80082, 0x315064c4c2ed997c}
#else
        {0xfffffffffffffffc, 0xffffffffffffffff, 0xffffffffffffffff,
         0xffffffffffffffff, 0x311bbe42b3b261ff, 0xe3628707154a5a6d,
         0x8d2971152db80082, 0x315064c4c2ed997c}
