...
target_include_directories(${LIB_HD_${SVARIANT_UPPER}} PRIVATE ${INC_COMMON} ${INC_PRECOMP_${SVARIANT_UPPER}} ${INC_PUBLIC} ${INC_GF} ${INC_GF_${SVARIANT_UPPER}} ${INC_EC} ${INC_HD} ${CMAKE_CURRENT_SOURCE_DIR}/../../../intbig/ref/generic/include)
