...
// Forward declaration for test function used in inline header function
// int test_point_order_twof(const ec_point_t *P, const ec_curve_t *curve, int
// f);
 ...
 *
 * Structure to hold 4 fp2_t elements representing a 2x2 matrix used when
 * computing a compatible theta structure during gluing.
 */
...
/**
 * @brief Compute the double of the theta couple point in on the elliptic
 * product E12
 *
...
/**
 * @brief Compute the iterated double of the theta couple point in on the
 * elliptic product E12
 *
 * @param out Output: the theta_couple_point
...
/**
 * @brief Compute the addition of two points in (X : Y : Z) coordinates on the
 * elliptic product E12
 *
...
/**
 * @brief Compute the iterated double of the theta couple jac point in on the
 * elliptic product E12
 *
 * @param out Output: the theta_couple_jac_point
 * @param n : the number of iteration
...
/**
 * @brief A forgetful function which returns (X : Z) points given a pair of (X :
 * Y : Z) points
 *
 ...
 */
static int test_couple_point_order_twof(const theta_couple_point_t *T,
                                        const theta_couple_curve_t *E, int t) {
