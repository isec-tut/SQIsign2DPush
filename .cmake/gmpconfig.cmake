...
if (ENABLE_GMP_BUILD)
  ...
  file(MAKE_DIRECTORY ${libgmp_INSTALL_DIR}/lib)
  ...
  set(GMP_LIBRARY ${libgmp_INSTALL_DIR}/lib/${CMAKE_STATIC_LIBRARY_PREFIX}gmp${GMP_LIB_SUFFIX})
  add_library(sqisign_gmp UNKNOWN IMPORTED GLOBAL)
  set_target_properties(sqisign_gmp PROPERTIES
    IMPORTED_LOCATION ${GMP_LIBRARY}
    INTERFACE_INCLUDE_DIRECTORIES ${libgmp_INSTALL_DIR}/include
  )
  add_dependencies(sqisign_gmp libgmp_external)
  set(GMP sqisign_gmp)
