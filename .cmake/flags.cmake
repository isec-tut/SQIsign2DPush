...
set(SQISIGN_SANITIZER_BUILD_TYPES ASAN LSAN MSAN UBSAN)
set(SQISIGN_ENABLE_RELEASE_OPTIMIZATIONS TRUE)
if(CMAKE_BUILD_TYPE IN_LIST SQISIGN_SANITIZER_BUILD_TYPES OR
   CMAKE_BUILD_TYPE STREQUAL "Debug")
	set(SQISIGN_ENABLE_RELEASE_OPTIMIZATIONS FALSE)
endif()
...
if(MSVC)
	...
	if(SQISIGN_ENABLE_RELEASE_OPTIMIZATIONS)
...
if(SQISIGN_ENABLE_RELEASE_OPTIMIZATIONS)
	# Enable link-time optimization (LTO) when supported by the toolchain.
	include(CheckIPOSupported)
	check_ipo_supported(RESULT SQISIGN_IPO_SUPPORTED OUTPUT SQISIGN_IPO_ERROR)
	if(SQISIGN_IPO_SUPPORTED)
		set(CMAKE_INTERPROCEDURAL_OPTIMIZATION TRUE)
	else()
		message(WARNING "IPO/LTO is not supported: ${SQISIGN_IPO_ERROR}")
	endif()
endif()
